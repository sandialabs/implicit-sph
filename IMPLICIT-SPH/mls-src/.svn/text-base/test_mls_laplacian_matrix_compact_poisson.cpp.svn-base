...
namespace LAMMPS_NS {
  ...
  namespace MLS {
    ...
    typedef class FunctorOuterLaplacianMatrixCompactPoisson<PairIsph> FunctorLaplacianMatrixCompactPoisson;
    
    int TestSuite::testMLS_LaplacianMatrixCompactPoisson() {
      int r_val = 0;
      ...
      double *b = NULL, *w = NULL;
      {
        ...
        _pair->memory->grow(b,         nmax, "test:mls:b");          // computed rhs
        _pair->memory->grow(w,         nmax, "test:mls:w");          // work space, w = A u 
      }
      ...
      // ** Test body
      {
        ...
        {
          FunctorLaplacianMatrixCompactPoisson functor(_pair, 1.0, f, normal, g, b, NULL);
          FilterBinary filter;
        ...
        {
          Epetra_Vector uu(View, *_pair->nodalmap, u);
          Epetra_Vector ww(View, *_pair->nodalmap, w);
          
          // w = A u
          _pair->A.crs->Multiply(false, uu, ww);
        }
      ...
      // ** Finalize 
      {
        ...
        _pair->memory->destroy(b);
        _pair->memory->destroy(w);
      }
      return r_val;
    }
