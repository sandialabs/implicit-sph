...
fid = fopen('channel-edl-mixed-2d.data', 'wt' );
...
cmd=sprintf("sed -i \'/--datafile/c\\variable           dx equal %f #--datafile\' channel-edl-mixed-2d.lmp", delta*1.1);
[r,s] = system(cmd);
disp(s);
